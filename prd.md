...
| GAP-010 | Ubuntu deb 已有 CI 安装和 Xvfb smoke，但尚无 Ubuntu 22.04 deb 实机、真实 ext4 SD 卡和长时导入证据 | 在 Ubuntu 22.04+ x86_64 实机验收 deb，并挂载真实 SD 卡完成只读导入、检查、回放、三格式导出和权限错误历史验收 |
